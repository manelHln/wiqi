...
export default function CashbackOffers() {
  ...
  return (
    <section className="bg-white py-8 md:py-12">
      ...
      <h2 className='text-center text-3xl font-bold'>1,526 offers from partner merchants with discounts</h2>
      <p className='text-center font-semibold text-xl py-4'>Order after order, earn an average of €120/year**</p>
      <div className="flex justify-center text-center mb-8">
        <Button variant="ghost" className="text-secondary hover:bg-gray-100 hover:text-secondary cursor-pointer rounded-3xl text-lg flex items-center justify-center gap-2">
