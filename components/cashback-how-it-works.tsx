...
const steps = [
  ...
  },
  {
    ...
    description:
      "Once I have accumulated €20, I can get my money back via bank transfer or PayPal",
            ...
            return (
              <div key={index} className="relative">
                <div className="flex flex-col items-center text-center">
                  ...
                  <h3 className="text-xl md:text-2xl lg:text-3xl font-bold mb-3 text-balance">
                    {step.title}
                  </h3>

                  <p className="text-gray-600 text-base md:text-lg leading-relaxed text-balance">
                    {step.description}
                  </p>
                </div>
