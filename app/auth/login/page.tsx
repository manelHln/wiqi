      ...
      <div className="w-full max-w-md bg-white p-8 rounded-lg shadow-sm">
        ...
        <div>
          ...
          <button
            ...
            className="w-full h-12 bg-gradient-to-r from-[#3bb1f9] via-[#60a5fa] to-[#40dbd5] hover:from-[#2499e0] hover:via-[#3b8ee8] hover:to-[#2cbab5] text-white rounded-lg mb-4 disabled:opacity-50 font-medium transition-all">
            {isSubmitting ? (
